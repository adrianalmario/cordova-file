...
CREATE TABLE `status1` (
  `id` int(11) NOT NULL,
  `device_name` varchar(123) NOT NULL,
  `battery_status` varchar(123) NOT NULL,
  `on_off` varchar(123) NOT NULL
...
INSERT INTO `status1` (`id`, `device_name`, `battery_status`, `on_off`) VALUES
(1, 'MCU_Device_1', '64', '1'),
(2, 'MCU_Device_2\r\n', '', ''),
(3, 'MCU_Device_3', '', '');
